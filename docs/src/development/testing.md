...
| **Total** | **7,290** | Authoritative count from `cargo test --all-features` (lib test binary): 7,261 run by default + 29 `#[ignore]`d. The per-category rows above are a maintained snapshot. Re-run `cargo test` for the live number. |
